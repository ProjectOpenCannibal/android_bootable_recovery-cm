...
int res_create_sdcard_multi_display_surface(const char* name,
                                     const char* storage_path, int* frames, gr_surface** pSurface);
...
int res_create_localized_alpha_surface(const char* name, const char* locale,
                                       gr_surface* pSurface);
int res_create_sdcard_localized_alpha_surface(const char* name, const char* storage_path, const char* locale,
                                       gr_surface* pSurface);
